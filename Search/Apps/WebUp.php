...
<div id="overlay">
  <div class="container" id="overlayContainer" style="position: relative; background: #000;">
    <!-- PHP LOADER (IFRAME) -->
    <iframe id="phpFrame" style="width: 100%; height: 100%; border: none; background: #000;"></iframe>
  </div>
</div>
...
<script>
let currentCategory = 'WebUp';
let currentSearch = '';
const phpFrame = document.getElementById('phpFrame');
...
async function searchScripts() {
  try {
    ...
    data.forEach(item => {
      ...
      // Pass the path directly to the opener
