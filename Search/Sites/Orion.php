...
button:hover {
    background: linear-gradient(135deg, #4caf50, #66bb6a); /* lighter green on hover */
...
#overlay .file-buttons button:hover {
    background: linear-gradient(135deg, #4caf50, #66bb6a); /* lighter green hover */
...
function runJSFile(fileName) {
    ...
    script.src = `Orion/${currentFolder}/${fileName}`;
