document.addEventListener('DOMContentLoaded', () => {
  ...
  const videoSets = [
    { video: 'x8ezvd2' },  // Attack of the Killer Garage Sale
    { video: 'x6udsmk' },  // My Brothers Keeper
    { video: 'x876hzv' },  // Kindread Spirits
    { video: 'x87807l' },  // Public Enemies
    { video: 'x8731w6' } // Torrent of Terror
  ];
