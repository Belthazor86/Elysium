document.addEventListener('DOMContentLoaded', () => {
  ...
  const videoSets = [
    { video: 'x7m924j' },  // A Stitch in Time (Part 1)
    { video: 'x7m924z' },  // A Stitch in time (Part 2)
    { video: 'x7mh3x0' },  //  A Stitch in time (Part 3)
    { video: 'x6ppcyo' },  //  Sink or Swim
    { video: 'x7yiwwa' },  // Tick, Tick, Tick
    { video: 'x6pm9fp' },  // Downhill
    { video: 'x7mmjw9' } // Hidden Talent
