document.addEventListener('DOMContentLoaded', () => {
  ...
  const videoSets = [
    { video: 'x6ppdds' },  // Return to Camp Wannaweep
    { video: 'x7mtkgb' },  // Trading Faces
    { video: 'x7ykzwx' },  // Pain King vs. Cleopatra
    { video: 'x7mqbqe' },  // Bonding
    { video: 'x7me0en' }, // The Ron Factor
    { video: 'x7mt9r2' }, // Car Alarm
    { video: 'x7m7x40' }, // Graduation Part 1
    { video: 'x7m7x55' }  // Graduation Part 2
  ];
