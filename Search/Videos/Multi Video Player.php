...
<button id="uploadButton" class="demo w3-opacity w3-hover-opacity-off button">Upload</button>
<button id="scanButton" class="demo w3-opacity w3-hover-opacity-off button">Video</button>
