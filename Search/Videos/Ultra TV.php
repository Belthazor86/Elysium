...
if (isset($_GET['embedScript'])) {
    ...
    $allowed = realpath(__DIR__ . '/Ultra TV');
...
if (isset($_GET['category'])) {
    ...
    $baseDir = __DIR__ . "/Ultra TV/$category";
    $results = [];
            ...
            if ($query === '' || strpos($normalizedFolder, $query) !== false) {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    $results[] = [
                        'title' => $folder,
                        'image' => $imageLink,
                        'script' => $scriptFile ? "Ultra TV/$category/$folder/Scripts/" . basename($scriptFile) : null,
                    ];
                }
            }
        }
