...
if (isset($_GET['scan'])) {
    ...
    $baseDir = __DIR__ . '/Andromedia';   // <-- change this to your music folder
        ...
        foreach ($albumDirs as $albumPath) {
            ...
            foreach ($files as $file) {
                ...
                if (in_array($ext, $imageExt) && !$cover) {
                    ...
                    $cover = 'Andromedia/' . rawurlencode($albumName) . '/' . rawurlencode($file);
                } elseif (in_array($ext, $audioExt)) {
                    $tracks[] = [
                        'name' => $file,
                        'url'  => 'Andromedia/' . rawurlencode($albumName) . '/' . rawurlencode($file)
                    ];
                }
            }
